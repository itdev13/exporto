...
export function FeatureCard({
  ...
  return (
    <div
      className="bg-white border-2 border-black rounded-xl p-6 shadow-[4px_4px_0_0_#000] transition-all duration-200 ease-out hover:translate-x-[-2px] hover:translate-y-[-2px] hover:shadow-[6px_6px_0_0_#000] relative overflow-hidden"
    >
      {/* Left accent bar */}
      {accentColor && (
        <div
